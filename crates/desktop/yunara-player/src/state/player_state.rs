...
impl ProgressSlider {
    ...
    pub fn formatted_current_time(&self) -> String { format_duration(self.current_time) }

    /// Formats the total duration as "M:SS" or "H:MM:SS".
    pub fn formatted_total_duration(&self) -> String { format_duration(self.total_duration) }
}
...
impl PlayerState {
    ...
    pub fn has_active_playlist(&self) -> bool { self.current_playlist.is_some() }

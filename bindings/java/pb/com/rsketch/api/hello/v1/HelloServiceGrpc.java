...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.rsketch.api.hello.v1.HelloProto.HelloRequest,
      com.rsketch.api.hello.v1.HelloProto.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Hello",
      requestType = com.rsketch.api.hello.v1.HelloProto.HelloRequest.class,
      responseType = com.rsketch.api.hello.v1.HelloProto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.rsketch.api.hello.v1.HelloProto.HelloRequest,
      com.rsketch.api.hello.v1.HelloProto.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<com.rsketch.api.hello.v1.HelloProto.HelloRequest, com.rsketch.api.hello.v1.HelloProto.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<com.rsketch.api.hello.v1.HelloProto.HelloRequest, com.rsketch.api.hello.v1.HelloProto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.rsketch.api.hello.v1.HelloProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.rsketch.api.hello.v1.HelloProto.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void hello(com.rsketch.api.hello.v1.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<com.rsketch.api.hello.v1.HelloProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
     ...
     * </pre>
     */
    public void hello(com.rsketch.api.hello.v1.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<com.rsketch.api.hello.v1.HelloProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub
     ...
     * </pre>
     */
    public com.rsketch.api.hello.v1.HelloProto.HelloResponse hello(com.rsketch.api.hello.v1.HelloProto.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.rsketch.api.hello.v1.HelloProto.HelloResponse> hello(
        com.rsketch.api.hello.v1.HelloProto.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((com.rsketch.api.hello.v1.HelloProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.rsketch.api.hello.v1.HelloProto.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.rsketch.api.hello.v1.HelloProto.HelloRequest,
              com.rsketch.api.hello.v1.HelloProto.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.rsketch.api.hello.v1.HelloProto.getDescriptor();
    }
